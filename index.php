...
<body>
   <!-- <div class="header">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
        ...
        <div class="logo">
            <a href="index.php"><img src="images/logo2.png" title="carwash" /></a>
        </div>
        ...
        <div class="collapse navbar-collapse " id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <?php 
                    ...
                    error_reporting(error_reporting() & ~E_NOTICE);
                    if($_SESSION["user"]==null){
                        ?><li class="nav-item dropdown"><a href="login.html" class="dropdown-item">Inscription/Connexion</li></a><?php
                    } else{
                        ?>
                            <li class="dropdown">
                                <a href="#" class="nav-link dropdown-toggle " id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Bienvenue <?php echo $_SESSION["user"]['fname'] ?></a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <div class="benner">
        ...
        <section id="team" class="pb-5">
            <div class="container">
                <h5 class="section-title h1">Nos services</h5>
                                    ...
                                    <div class="frontside">
                                        <div class="card">
                                            <div class="card-body text-center">
                                                <p><img class=" img-fluid" src="images/icons8-nettoyage-de-voiture-100.png" alt="card image"></p>
                        ...
                        <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                            <div class="mainflip">
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <p><img class=" img-fluid" src="images/icons8-services-100.png" alt="card image"></p>
                        ...
                        <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                            <div class="mainflip">
                                <div class="frontside">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <p><img class=" img-fluid" src="images/icons8-temps-100.png" alt="card image"></p>
